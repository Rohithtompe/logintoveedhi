                        ...
                        <td style={{
                          ...
                          {editingId === dsaCode.id ? (
                            <select
                              className="form-select form-select-sm"
                              name="branch_state"
                              value={editFormData.branch_state || ''}
                              onChange={handleEditChange}
                              style={{
                                width: '100%',
                                border: '2px solid #f59e0b',
                            ...
                            <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                              ...
                              {getNameById(dsaCode.branch_state, branchInnerStates)}
                            </div>
                          )}
                        </td>
                          ...
                          {editingId === dsaCode.id ? (
                            <>
                              <select
                                ...
                                onChange={handleEditChange}
                                disabled={!editFormData.branch_state}
                                style={{
                                  width: '100%',
                                  border: '2px solid #f59e0b',
                                  borderRadius: '8px',
                                  padding: '8px 12px',
                                  fontSize: '0.9rem',
                                  background: !editFormData.branch_state ? '#f3f4f6' : 'white'
                                }}
                              >
                                <option value="">
                              ...
                              {editFormData.branch_state && filteredLocations.length === 0 && (
                                <div style={{
                                  marginTop: '5px',
                                  color: '#d97706',
                                  fontSize: '0.8rem'
                            ...
                            <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                              ...
                              {getNameById(dsaCode.branch_location, branchInnerLocations)}
                            </div>
                          )}
                        </td>
