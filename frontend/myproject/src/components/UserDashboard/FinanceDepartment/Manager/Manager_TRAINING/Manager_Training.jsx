...
import Manager_Sidebar from "../Sidebar/Manager_Sidebar.jsx";
// Remove this line if Manager_Sidebar.jsx already imports the CSS
import "../Sidebar/Manager_Sidebar.css";
import { 
  FaVideo, 
  FaUserCircle, 
  FaChalkboardTeacher, 
  ...
  const handleModuleClick = (moduleTitle) => {
    ...
    switch(moduleTitle) {
      case 'Type of Loan Video':
        navigate('/finance/manager/loan-video-list');  // Updated path
        break;
      case 'Profile':
        navigate('/finance/manager/profile-list');
        break;
      case 'Seminars':
        navigate('/finance/manager/seminars-list');
        break;
      case 'Policy':
        navigate('/finance/manager/policy-list');
        break;
      case 'offers':
        navigate('/finance/manager/offers-list');
        break;
      case 'News':
        navigate('/finance/manager/news-list');
        break;
      case 'Policy Images':
        navigate('/finance/manager/policy-images-list');
        break;
      default:
        navigate('/finance/manager/training');
    }
  };
...
export default Manager_Training;