  ...
  const handleModuleClick = (moduleTitle) => {
    ...
    switch(moduleTitle) {
      case 'Type of Loan Video':
        navigate('/finance/asstmanager/loan-video-list');  // Updated path
        break;
      case 'Profile':
        navigate('/finance/asstmanager/profile-list');
        break;
      case 'Seminars':
        navigate('/finance/asstmanager/seminars-list');
        break;
      case 'Policy':
        navigate('/finance/asstmanager/policy-list');
        break;
      case 'offers':
        navigate('/finance/asstmanager/offers-list');
        break;
      case 'News':
        navigate('/finance/asstmanager/news-list');
        break;
      case 'Policy Images':
        navigate('/finance/asstmanager/policy-images-list');
        break;
      default:
        navigate('/finance/asstmanager/training');
    }
  };
...
export default AManager_Training;