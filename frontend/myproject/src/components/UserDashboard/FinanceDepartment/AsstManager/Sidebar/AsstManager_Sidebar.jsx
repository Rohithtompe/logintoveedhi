...
import "./AsstManager_Sidebar.css";
...
function AsstManager_Sidebar() {
  const [expandedMenus, setExpandedMenus] = useState(["Asst Manager Dashboard"]);
  const [activeMenu, setActiveMenu] = useState("Asst Manager Dashboard");
  ...
  const menuItems = [
    {
      ...
      name: 'Dashboard',
      icon: <HouseFill />,
      path: '/finance/asst-manager/dashboard',
      children: []
    },
    {
      ...
      name: 'Dsa-Code',
      icon: <PersonBadge />,
      path: '/finance/asst-manager/Dsa-Code',
      children: []
    },
    {
      id: 3,
      name: 'Bankers',
      icon: <Building />,
      path: '/finance/asst-manager/bankers',
      children: [{ id: 21, name: 'Add', icon: <PlusCircle />, path: '/finance/asst-manager/add' },
      { id: 22, name: 'list', icon: <List />, path: '/finance/asst-manager/list' },
      ]
    },
    {
      ...
      name: 'Payout',
      icon: <CashStack />,
      path: '/finance/asst-manager/payout',
      children: []
    },
    {
      id: 5,
      name: 'Training',
      icon: <Book />,
      path: '/finance/asst-manager/training',
      children: []
    },
    ...
    <div className="hr-sidebar">
      <div className="hr-sidebar-header">
        <div className="sidebar-logo">
          <a href="/finance/asst-manager/dashboard" className="logo-container">
...
export default AsstManager_Sidebar;