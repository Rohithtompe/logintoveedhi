  ...
  const handleModuleClick = (moduleTitle) => {
    ...
    switch(moduleTitle) {
      case 'Type of Loan Video':
        navigate('/marketing/bh/loan-video-list');  // Updated path
        break;
      case 'Profile':
        navigate('/marketing/bh/profile-list');
        break;
      case 'Seminars':
        navigate('/marketing/bh/seminars-list');
        break;
      case 'Policy':
        navigate('/marketing/bh/policy-list');
        break;
      case 'offers':
        navigate('/marketing/bh/offers-list');
        break;
      case 'News':
        navigate('/marketing/bh/news-list');
        break;
      case 'Policy Images':
        navigate('/marketing/bh/policy-images-list');
        break;
      default:
        navigate('/marketing/bh/training');
    }
  };
