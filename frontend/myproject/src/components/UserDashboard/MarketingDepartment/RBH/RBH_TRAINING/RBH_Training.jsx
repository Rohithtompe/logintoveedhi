  ...
  const handleModuleClick = (moduleTitle) => {
    ...
    switch(moduleTitle) {
      case 'Type of Loan Video':
        navigate('/marketing/rbh/loan-video-list');  // Updated path
        break;
      case 'Profile':
        navigate('/marketing/rbh/profile-list');
        break;
      case 'Seminars':
        navigate('/marketing/rbh/seminars-list');
        break;
      case 'Policy':
        navigate('/marketing/rbh/policy-list');
        break;
      case 'offers':
        navigate('/marketing/rbh/offers-list');
        break;
      case 'News':
        navigate('/marketing/rbh/news-list');
        break;
      case 'Policy Images':
        navigate('/marketing/rbh/policy-images-list');
        break;
      default:
        navigate('/marketing/rbh/training');
    }
  };
