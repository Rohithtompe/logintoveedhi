...
function RBH_Sidebar() {
  const [expandedMenus, setExpandedMenus] = useState(["RBH Dashboard"]);
  const [activeMenu, setActiveMenu] = useState("RBH Dashboard");
  ...
  const menuItems = [
    ...
    },
    {
      ...
      name: 'Bankers',
      icon: <Bank />,
      path: '/marketing/rbh/bankers/',
      children: [{ id: 21, name: 'Add', icon: <PlusCircle />, path: '/marketing/rbh/addbank' },
      { id: 22, name: 'list', icon: <List />, path: '/marketing/rbh/listbank' },
      ]
    },
    {
      id: 7,
    ...
    <div className="hr-sidebar">
      <div className="hr-sidebar-header">
        <div className="sidebar-logo">
          <a href="/marketing/rbh/dashboard" className="logo-container">
