  ...
  const handleModuleClick = (moduleTitle) => {
    ...
    switch(moduleTitle) {
      case 'Type of Loan Video':
        navigate('/marketing/cbo/loan-video-list');  // Updated path
        break;
      case 'Profile':
        navigate('/marketing/cbo/profile-list');
        break;
      case 'Seminars':
        navigate('/marketing/cbo/seminars-list');
        break;
      case 'Policy':
        navigate('/marketing/cbo/policy-list');
        break;
      case 'offers':
        navigate('/marketing/cbo/offers-list');
        break;
      case 'News':
        navigate('/marketing/cbo/news-list');
        break;
      case 'Policy Images':
        navigate('/marketing/cbo/policy-images-list');
        break;
      default:
        navigate('/marketing/cbo/training/dashboard');
    }
  };
