...
function CBO_Sidebar() {
  const [expandedMenus, setExpandedMenus] = useState(["CBO Dashboard"]);
  const [activeMenu, setActiveMenu] = useState("CBO Dashboard");
  ...
  const menuItems = [
    ...
    },
    {
      ...
      name: 'Bankers',
      icon: <Bank />,
      path: '/marketing/cbo/bankers',
      children: [{ id: 21, name: 'Add', icon: <PlusCircle />, path: '/marketing/cbo/addbank' },
      { id: 22, name: 'list', icon: <List />, path: '/marketing/cbo/listbank' },
      ]
    },
    {
      id: 7,
      name: 'Training',
      icon: <Book />,
      path: '/marketing/cbo/training/dashboard',
      children: []
    },
  ];
    ...
    <div className="hr-sidebar">
      <div className="hr-sidebar-header">
        <div className="sidebar-logo">
          <a href="/marketing/cbo/dashboard" className="logo-container">
