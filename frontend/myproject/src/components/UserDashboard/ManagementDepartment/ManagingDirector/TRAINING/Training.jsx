...
import "../../ManagingDirector/Sidebar/ManagingDirector_Sidebar.jsx";
import { 
  FaVideo, 
  FaUserCircle, 
  FaChalkboardTeacher, 
  ...
  const handleModuleClick = (moduleTitle) => {
    ...
    switch(moduleTitle) {
      case 'Type of Loan Video':
        navigate('/management/managing-director/loan-video-list');  // Updated path
        break;
      case 'Profile':
        navigate('/management/managing-director/profile-list');
        break;
      case 'Seminars':
        navigate('/management/managing-director/seminars-list');
        break;
      case 'Policy':
        navigate('/management/managing-director/policy-list');
        break;
      case 'offers':
        navigate('/management/managing-director/offers-list');
        break;
      case 'News':
        navigate('/management/managing-director/news-list');
        break;
      case 'Policy Images':
        navigate('/management/managing-director/policy-images-list');
        break;
      default:
        navigate('/management/managing-director/training');
    }
  };
