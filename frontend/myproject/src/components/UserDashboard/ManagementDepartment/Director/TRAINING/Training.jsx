  ...
  const handleModuleClick = (moduleTitle) => {
    ...
    switch(moduleTitle) {
      case 'Type of Loan Video':
        navigate('/management/director/loan-video-list');  // Updated path
        break;
      case 'Profile':
        navigate('/management/director/profile-list');
        break;
      case 'Seminars':
        navigate('/management/director/seminars-list');
        break;
      case 'Policy':
        navigate('/management/director/policy-list');
        break;
      case 'offers':
        navigate('/management/director/offers-list');
        break;
      case 'News':
        navigate('/management/director/news-list');
        break;
      case 'Policy Images':
        navigate('/management/director/policy-images-list');
        break;
      default:
        navigate('/management/director/training');
    }
  };
