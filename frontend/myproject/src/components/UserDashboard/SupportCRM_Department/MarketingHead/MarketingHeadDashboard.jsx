      ...
      <div style={{
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', position: 'relative', zIndex: 1 }}>
            <div>
              <div style={{
                ...
                Marketing Head Director Dashboard
              </div>
              <h1 style={{
                fontSize: '2.5rem',
                fontWeight: '800',
              ...
              <div style={{
                ...
                <p style={{
                  ...
                  Welcome back! Manage your team efficiently with powerful Managing Director tools.
                </p>
              </div>
            </div>
        ...
        <div style={{
          ...
          {[
            ...
            <div
              key={index}
              onClick={() => navigate("/support-crm/marketing-head/active-employee")}
              style={{
                cursor: "pointer",
