...
import MarketingHead_Sidebar from "../../MarketingHead/Sidebar/MarketingHead_Sidebar.jsx";
import "../../MarketingHead/Sidebar/MarketingHead_Sidebar.css";
import { 
  FaVideo, 
  FaUserCircle, 
  FaChalkboardTeacher, 
  ...
  const handleModuleClick = (moduleTitle) => {
    ...
    switch(moduleTitle) {
      case 'Type of Loan Video':
        navigate('/support-crm/marketing-head/loan-video-list');  // Updated path
        break;
      case 'Profile':
        navigate('/support-crm/marketing-head/profile-list');
        break;
      case 'Seminars':
        navigate('/support-crm/marketing-head/seminars-list');
        break;
      case 'Policy':
        navigate('/support-crm/marketing-head/policy-list');
        break;
      case 'offers':
        navigate('/support-crm/marketing-head/offers-list');
        break;
      case 'News':
        navigate('/support-crm/marketing-head/news-list');
        break;
      case 'Policy Images':
        navigate('/support-crm/marketing-head/policy-images-list');
        break;
      default:
        navigate('/support-crm/marketing-head/training');
    }
  };
