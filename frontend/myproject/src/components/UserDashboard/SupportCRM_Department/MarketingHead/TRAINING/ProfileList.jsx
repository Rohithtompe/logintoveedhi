        ...
        <div style={{
          ...
          {(showCreateForm || editingProfile) && (
            <div style={{
              ...
              {/* Profile component placeholder - uncomment when Profile component is available */}
              {/* <Profile 
          ...
          {loading ? (
            <div style={{
              ...
              <p style={{ color: '#78350f', fontSize: '1.1rem' }}>Loading profiles...</p>
            </div>
          ) : profiles.length === 0 ? (
            <div style={{
              textAlign: 'center',
              ...
              <i className="bi bi-person" style={{ fontSize: '4rem', color: '#92400e', opacity: 0.5 }}></i>
                  ...
                  {profiles.map((profile, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td style={{ padding: '15px' }}>
                          <div>
                            <strong style={{ color: '#78350f' }}>{getVendorBankName(profile.vendor_bank)}</strong>
                          </div>
                        ...
                        <td style={{ padding: '15px', textAlign: 'center' }}>
                          <span style={{
                            background: profile.status ? '#10b981' : '#6b7280',
                            color: 'white',
                            padding: '5px 10px',
                            borderRadius: '20px',
                            fontSize: '0.85rem'
