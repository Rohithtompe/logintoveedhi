  ...
  const handleModuleClick = (moduleTitle) => {
    ...
    switch(moduleTitle) {
      case 'Type of Loan Video':
        navigate('/support-crm/marketing-manager/loan-video-list');  // Updated path
        break;
      case 'Profile':
        navigate('/support-crm/marketing-manager/profile-list');
        break;
      case 'Seminars':
        navigate('/support-crm/marketing-manager/seminars-list');
        break;
      case 'Policy':
        navigate('/support-crm/marketing-manager/policy-list');
        break;
      case 'offers':
        navigate('/support-crm/marketing-manager/offers-list');
        break;
      case 'News':
        navigate('/support-crm/marketing-manager/news-list');
        break;
      case 'Policy Images':
        navigate('/support-crm/marketing-manager/policy-images-list');
        break;
      default:
        navigate('/support-crm/marketing-manager/training');
    }
  };
